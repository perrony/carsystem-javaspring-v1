...
public class EnderecoEmpresa implements Serializable{
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "empresa_enderecos_seq")
	@SequenceGenerator(name = "empresa_enderecos_seq", sequenceName = "empresa_enderecos_seq", allocationSize = 1)
	private Long id;
	...
	public String getUrl() {
		return "#collapse_" + (this.getId()).toString();
	}
