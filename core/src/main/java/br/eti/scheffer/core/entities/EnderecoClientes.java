...
public class EnderecoClientes implements Serializable{
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "clientes_enderecos_seq")
	@SequenceGenerator(name = "clientes_enderecos_seq", sequenceName = "clientes_enderecos_seq", allocationSize = 1)
	private Long id;
